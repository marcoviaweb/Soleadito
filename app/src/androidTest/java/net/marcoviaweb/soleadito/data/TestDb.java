 ...
 */
package net.marcoviaweb.soleadito.data;
...
public class TestDb extends AndroidTestCase {
    ...
    public void testInsertReadDb(){
        ...
        Log.d(LOG_TAG, "Nuevo id de fila: " + locationRowId);
        ...
        if (cursor.moveToFirst()){
            ...
            if (weatherCursor.moveToFirst()){
                int dateIndex = weatherCursor.getColumnIndex(WeatherEntry.COLUMN_DATE);
                ...
                fail("No se han retornado valores del clima :( ");
            }
        } else {
            fail("No se han retornado valores :( ");
        }
